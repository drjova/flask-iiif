...
.. code-block:: python
    ...
    @iiif_before_process_request.connect_via(current_app)
    ...
    @iiif_after_process_request.connect_via(current_app)
    ...
    @iiif_after_validation.connect_via(current_app)
...
# After validation
iiif_after_validation = _signals.signal('iiif-after-validation')
